...
exports.getProducts = async (req:any, res:any): Promise<void> => {
  try {
...
exports.getRestaurants = async (req:any, res:any): Promise<void> => {
  try {
...
exports.getCategories = async (req:any, res:any): Promise<void> => {
  try {
